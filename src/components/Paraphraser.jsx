    ...
    <main className='w-10/12 m-auto px-3 my-[4rem]'>
      <div className='paraphraser flex flex-col lg:flex-row'>
        <div className='relative textarea flex-1 mb-6 lg:mr-6'>
          <label htmlFor="text" className="block mb-2 font-medium text-gray-90 text-lg">თქვენი ტექსტი <span className='max float-right'>{charlength} / 2000</span></label>
        ...
        <div className='relative textarea flex-1'>
          <label htmlFor="text-output" className="block mb-2 text-lg font-medium text-gray-900">პერიფრაზირებული ტექსტი</label>
          ...
          {loading && 
            <div role="status" className='absolute top-[50%] right-[50%] translate-x-[50%] flex justify-center items-center'>
