		...
		<div className="max-w-[24rem] p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8">
			...
			{data.price === 0 ? (
				...
				<button
					onClick={buy}
					type="button"
					className="text-white bg-[#60A5FA] hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-200 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">
					გაწევრიანდი
				</button>
			)}
		</div>
