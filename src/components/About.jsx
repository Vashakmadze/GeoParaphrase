...
function About() {
	...
	const aboutProject =
		"ქართული პერიფრაზირების ხელსაწყო შექმნილია იმისთვის, რომ დაგეხმაროთ ტექსტის ქართულ ენაზე სწრაფად და ზუსტად დამუშავებაში. გჭირდებათ თუ არა სტატიის, ესეს ან სხვა წერილობითი შინაარსის პერიფრაზირება ან გაშინაარსება, ჩვენი ინსტრუმენტი მოგაწვდით მაღალი ხარისხის შედეგებს, რომლებიც თავისუფალია პლაგიატისგან.";
